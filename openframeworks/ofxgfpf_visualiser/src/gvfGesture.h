...
#ifndef __ofGfpfVisualiser__ofGesture__
#define __ofGfpfVisualiser__ofGesture__

#include <iostream>
#include "ofMain.h"

#endif /* defined(__ofGfpfVisualiser__ofGesture__) */

// the gfpfGesture class is used to represent the gesture throughout the application.
...
// a gfpfGesture should also contain all the information needed in order to draw the gesture to the screen.
...
class gfpfGesture
{
    public:
        gfpfGesture();
        gfpfGesture(ofRectangle _drawArea);
        ~gfpfGesture();
